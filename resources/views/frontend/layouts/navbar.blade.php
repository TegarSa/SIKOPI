<div class="navbar-wrapper">
    ...
    <div class="topbar py-3 text-white d-none d-md-block" style="background: transparent; font-size: 13px;">
    ...
    <div class="container mt-1 mb-4 p-0 px-3" style="max-width: 1200px; margin: 0 auto;">
        <nav class="navbar navbar-expand-lg navbar-light shadow-sm p-0 border-0"
            style="background-color: #fcfdfd; min-height: 85px; border-radius: 4px;">

            <div class="container-fluid p-0 d-flex align-items-stretch" style="min-height: 85px;">

                <a class="navbar-brand d-flex align-items-center ps-4 m-0 text-decoration-none"
                    href="#" style="min-height: 85px; gap: 12px;">
                    ...
                    <div class="d-flex flex-column justify-content-center" style="line-height: 1;">
                        <span style="color: #162224; font-weight: 800; font-size: 1.8rem;">SIKOPI</span>
                        <span style="color: #8e847e; font-weight: 600; font-size: 6.2px; text-transform: uppercase;">
                            SISTEM KOPERASI INTERNAL
                        </span>
                    </div>
                </a>

                <button class="navbar-toggler me-3 align-self-center"
                    type="button"
                ...
                <div class="collapse navbar-collapse d-lg-flex align-items-stretch" id="frontNavbar">
                    ...
                    <ul class="navbar-nav ms-auto d-flex flex-row align-items-center px-4 mb-0">
                        ...
                        <li class="nav-item dropdown custom-dropdown">
                            <a class="nav-link dropdown-toggle px-3 fw-semibold text-dark"
                                href="#"
                                role="button"
...
document.addEventListener("DOMContentLoaded", function () {
    const navbarCollapse = document.getElementById("frontNavbar");
    const navLinks = document.querySelectorAll("#frontNavbar .nav-link:not(.dropdown-toggle)");
