...
@section('title', 'Syarat & Kuasa Potong Gaji - SIKOPI')
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <div class="fw-bold text-dark mb-1" style="font-size: 1.05rem;">Surat Kuasa Pemotongan Gaji Bulanan (Otorisasi HRD)</div>
                                        <div class="text-secondary" style="font-size: 0.88rem; line-height: 1.5;">Surat otoritas persetujuan resmi kepada Tim Bendahara / Payroll untuk melakukan pemotongan otomatis.</div>
                                    </div>
                                </div>
                            </td>
                            <td class="text-center"><span class="file-badge badge-docx">DOCX</span></td>
                            <td class="text-center fw-bold text-secondary" style="font-size: 0.9rem;">112 KB</td>
                            <td class="text-center text-muted" style="font-size: 0.88rem;">15 Feb 2026</td>
                            <td class="text-end">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <div class="fw-bold text-dark mb-1" style="font-size: 1.05rem;">Syarat & Ketentuan Batas Maksimal Potongan (Max 50%)</div>
                                        <div class="text-secondary" style="font-size: 0.88rem; line-height: 1.5;">Pedoman kalkulasi batas aman akumulasi potongan gaji dari Take Home Pay (THP) bulanan pegawai.</div>
                                    </div>
                                </div>
                            </td>
                            <td class="text-center"><span class="file-badge badge-pdf">PDF</span></td>
                            <td class="text-center fw-bold text-secondary" style="font-size: 0.9rem;">180 KB</td>
                            <td class="text-center text-muted" style="font-size: 0.88rem;">18 Feb 2026</td>
                            <td class="text-end">
                                <a href="#" class="btn-download-action"><i class="bi bi-download"></i> Unduh</a>
                            </td>
                        </tr>
        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6 col-12">
                <div class="feature-info-card">
                    ...
                    <h3 style="color: var(--color-primary); font-weight: 700; font-size: 1.25rem;" class="mb-2">Legalitas Hukum</h3>
                    <p style="color: var(--color-charcoal); font-size: 0.95rem; line-height: 1.6; margin-bottom: 0;">
                        Surat kuasa memuat kekuatan hukum mengikat bagi Pengurus SIKOPI dan unit Payroll Keuangan Dinas Inspektorat.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="feature-info-card">
                    ...
                    <h3 style="color: var(--color-primary); font-weight: 700; font-size: 1.25rem;" class="mb-2">Batas Cut-Off</h3>
                    <p style="color: var(--color-charcoal); font-size: 0.95rem; line-height: 1.6; margin-bottom: 0;">
                        Penyerahan dokumen otorisasi paling lambat tanggal 20 agar dapat diberlakukan pada penggajian bulan berjalan.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-12 col-12">
                <div class="feature-info-card">
                    ...
                    <h3 style="color: var(--color-primary); font-weight: 700; font-size: 1.25rem;" class="mb-2">Batas Maksimum 50%</h3>
                    <p style="color: var(--color-charcoal); font-size: 0.95rem; line-height: 1.6; margin-bottom: 0;">
                        Total pemotongan gaji tidak boleh melebihi 50% dari THP guna menjaga stabilitas finansial anggota.
                    </p>
                </div>
            </div>
        </div>
