        ...
        <div class="col-md-4 d-flex">
            <div class="card flex-fill">
                <div class="card-body">
                    <div class="row">
                        <div class="col mt-0">
                            <h5 class="card-title text-muted text-uppercase fs-6 fw-bold">Total Laba Koperasi</h5>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="mb-0">
                        <span class="badge bg-info-light text-info">Bruto</span>
                        <span class="text-muted text-nowrap ms-1">Sebelum Dibagi</span>
                    </div>
                </div>
            </div>
        </div>
